...
describe('MQTooltip Component', () => {
  ...
  it('should render with complex children', () => {
    const ComplexChild = React.forwardRef<HTMLDivElement>((props, ref) => (
  ...
  it('should handle long title text', () => {
    const longTitle = 'This is a very long tooltip text that should be displayed properly in the tooltip component and should not cause any issues with rendering or layout'
    const { container } = render(
