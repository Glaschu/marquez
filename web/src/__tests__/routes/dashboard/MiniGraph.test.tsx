...
describe('MiniGraph Component', () => {
  ...
  it('should show skeleton when no metrics provided', () => {
    const { container } = render(
      <MiniGraph intervalMetrics={undefined} isLoading={false} color="#ff0000" label="Test Metric" />
    )
  ...
  it('should render LineChart when metrics are provided and not loading', () => {
    render(
      <MiniGraph intervalMetrics={mockMetrics} isLoading={false} color="#ff0000" label="Test Metric" />
    )
  ...
  it('should render with weekly data format', () => {
    render(
      <MiniGraph intervalMetrics={mockWeekMetrics} isLoading={false} color="#0000ff" label="Datasets" />
    )
  ...
  it('should handle empty metrics array', () => {
    render(
      <MiniGraph intervalMetrics={[]} isLoading={false} color="#ff0000" label="Empty" />
    )
